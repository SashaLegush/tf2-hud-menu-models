...
I've added the decompiled assets in https://github.com/SashaLegush/tf2-hud-menu-models/tree/main/decompiled , if you are interested in making custom models for tf2/compiling more models (casual and competitive badges), take a look there!
